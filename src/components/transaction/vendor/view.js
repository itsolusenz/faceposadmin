...
import data from "../../../assets/data/vendor_list";
...
const Sub_category = () => {
	...
	return (
		...
		<Fragment>
			<Breadcrumb title="Vendor" parent="Transaction Extension" /> 
				...
				<Row>
					...
					<Col sm="12">
						<Card>
							<CardHeader>
											<Row>
															<Col sm="6"><h5>Vendor Listing</h5></Col>  								
															<Col sm="6">
																	<div className="btn-popup pull-right">
																		<a href="/accounts/vendor/add">
																		<button type="button"  data-original-title="test"  className="btn btn-light-gradien">Add </button>
																		</a>
																	</div>
															</Col>
											</Row>  
					...
					<Col sm="12">
						<Card>
							...
							<Col sm="6">
									<div className="btn-popup pull-right">
									    <a href="/accounts/vendor/add">
										<button type="button"  data-original-title="test"  className="btn btn-light-gradien">Add Vendor</button>
										</a>
									</div>
							</Col></Row>  
							</CardHeader>
	...
	{/*return (
		<Fragment>
			<Breadcrumb title="Vendor Listing Page" parent="Accounts" />
					...
					<Col sm="12">
						<Card>
							...
							<CardBody>
								<div className="btn-popup pull-right">
								<a href="/accounts/vendor/add">
										<button type="button"  data-original-title="test"  class="btn btn-primary">Add Vendor</button>
										</a>
