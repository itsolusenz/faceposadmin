...
import data from "../../../assets/data/transaction_supplier";
...
const Sub_category = () => {
	...
	return (
		...
		<Fragment>
			<Breadcrumb title="Supplier" parent="Transaction Extension" /> 
				...
				<Row>
					...
					<Col sm="12">
						<Card>
							<CardHeader>
											<Row>
															<Col sm="6"><h5>Supplier Listing</h5></Col>  								
															<Col sm="6">
																	<div className="btn-popup pull-right">
																		<a href="/accounts/supplier/add">
	...
	{/*return (
		<Fragment>
			<Breadcrumb title="Transaction Supplier Listing Page" parent="Physical" />
			...
			<Container fluid={true}>
				<Row>
					<Col sm="12">
						<Card>
							<CardHeader>
								<h5>Transaction Supplier Listing</h5>
							</CardHeader>
							<CardBody>
								<div className="btn-popup pull-right">
								<a href="/accounts/supplier/add">
										<button type="button"  data-original-title="test"  class="btn btn-primary">Add Supplier</button>
										</a>
