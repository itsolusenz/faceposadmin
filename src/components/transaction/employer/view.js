...
const Sub_category = () => {
	...
	return (
		...
		<Fragment>
			<Breadcrumb title="Employer" parent="Transaction Extension" /> 
				...
				<Row>
					...
					<Col sm="12">
						<Card>
							<CardHeader>
											<Row>
															<Col sm="6"><h5>Transaction Employer Listing</h5></Col>  								
															<Col sm="6">
																	<div className="btn-popup pull-right">
																		<a href="/transaction/employer/add">
...
{/*	return (
		<Fragment>
			<Breadcrumb title="Transaction Employer Listing Page" parent="Transaction " />
			...
			<Container fluid={true}>
				<Row>
					<Col sm="12">
						<Card>
							<CardHeader>
								<h5>Transaction Employer Listing</h5>
							</CardHeader>
							<CardBody>
								<div className="btn-popup pull-right">
								<a href="/transaction/employer/add">
										<button type="button"  data-original-title="test"  class="btn btn-primary">Add Employer</button>
										</a>
