...
import data from "../../../assets/data/packagesorder";
...
const Sub_category = () => {
	...
	return (
		...
		<Fragment>
			<Breadcrumb title="Packages" parent="Packages Extension" /> 
				...
				<Row>
					...
					<Col sm="12">
						<Card>
							<CardHeader>
											<Row>
															<Col sm="6"><h5>Packages Order Listing</h5></Col>  								
															<Col sm="6">
																	<div className="btn-popup pull-right">
																		<a href="/packages/order/add">
																		<button type="button"  data-original-title="test"  className="btn btn-light-gradien">Add Packages</button>
																		</a>
																	</div>
															</Col>
											</Row>  
...
{/*	return (
		<Fragment>
			<Breadcrumb title="Package Order Listing Page" parent="Packages" />		
			<Container fluid={true}>
				<Row>
					<Col sm="12">
						<Card>
							<CardHeader>
								<h5>Package Order Listing</h5>
							</CardHeader>
							<CardBody>
								<div className="btn-popup pull-right">
								<a href="/packages/order/add">
										<button type="button"  data-original-title="test"  class="btn btn-primary">View Packages Order</button>
										</a>
