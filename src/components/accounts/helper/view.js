...
const Category = () => {
	...
	useEffect(() => {
		...
		jsCookie.set('pagename','Helper');
		jsCookie.set('pagehead','accounts');
		
							
		                        fetch('https://api.laabamone.com/api/v1/Masters/GetResumeList')
	...
	return (
		...
		<Fragment>
			<Breadcrumb title="Helper" parent="Accounts Extension" /> 
				...
				<Row>
					...
					<Col sm="12">
						<Card>
							...
							<Row>
								<Col  sm="3">
								<a href="/accounts/Helper/add">
								<button type="button"  data-original-title="test"  className="btn btn-success">Add Helper</button>
								</a>	
								</Col>
								<Col  sm="4">
			...
			<Container fluid={true}>
				<Row>
					...
					<Col sm="12">
						...
						{/*}	<CardHeader>
							<Row>
							<Col sm="6"><h5>Helper Listing</h5></Col>  								
							<Col sm="6">
									<div className="btn-popup pull-right">
									    <a href="/accounts/Helper/add">
										<button type="button"  data-original-title="test"  className="btn btn-light-gradien">Add Helper</button>
										</a>
									</div>
							</Col></Row>  
							</CardHeader>*/}
